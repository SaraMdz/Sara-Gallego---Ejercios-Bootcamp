...
Arc(130,240,240,240,108,anguloDeBarrido2,fill="naranja")
Arc(130,240,240,240,197,anguloDeBarrido3,fill="oro")
Arc(130,240,240,240,253,anguloDeBarrido4,fill="verde")
Arc(130,240,240,240,277,anguloDeBarrido5,fill="azulGandul")
Arc(130,240,240,240,295,anguloDeBarrido6,fill="purpura")
Arc(130,240,240,240,299,anguloDeBarrido7,fill="rosadoFuerte")

Rect(260,40,10,10,fill="rojo")
Rect(260,60,10,10,fill="naranja")
Rect(260,80,10,10,fill="oro")
Rect(260,100,10,10,fill="verde")
Rect(260,20,10,10,fill="azulGandul")
Rect(260,120,10,10,fill="purpura")
Rect(260,140,10,10,fill="rosadoFuerte")

Rotulo("Cristianismo",310,42)
Rotulo("Islam",296,62)
Rotulo("Hinduismo",308,82)
Rotulo("Budismo",301,102)
